          ...
          md:max-w-2xl' key={index}>
            <div className='md:flex'>
              <div className='md:shrink-0'>
                <img id='image' src={`https://image.tmdb.org/t/p/w500/${oneMovie.poster_path}`} className='h-full w-full object-cover md:h-full md:w-48' alt="img not found" />
              </div>
              <div className='p-8'>
                <div id='title' className='uppercase tracking-wide text-lg leading-tight font-semibold'>
                   {oneMovie.title}
                </div>
                <hr />
                <br />
                <p id='overview'>{oneMovie.overview.substring(0, 100)}...</p>
